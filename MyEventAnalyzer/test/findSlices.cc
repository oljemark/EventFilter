{
 ...
 auto xy1c=f.Get<TH2F>("x_right_near_y_right_near_band1_cut4;1");
 auto xy2c=f.Get<TH2F>("x_right_near_y_right_near_band2_cut4;1");
 auto xy0c=f.Get<TH2F>("x_right_near_y_right_near_band_none_cut4;1");
 auto xyc=(TH2F*) xy1c->Clone("x_right_near_y_right_near_all_cut4");
 xyc->Add(xy2c);
 xyc->Add(xy0c);
 auto xy1cr=(TH2F*) xy1c->Clone("x_right_near_y_right_near_band1_cut4_fraction");
 xy1cr->Divide(xyc);
 auto xy2cr=(TH2F*) xy2c->Clone("x_right_near_y_right_near_band2_cut4_fraction");
 xy2cr->Divide(xyc);
 auto xy0cr=(TH2F*) xy0c->Clone("x_right_near_y_right_near_band_none_cut4_fraction");
 xy0cr->Divide(xyc);

 auto xx1c=f.Get<TH2F>("x_right_near_dx_right_band1_cut4;1");
 auto xx2c=f.Get<TH2F>("x_right_near_dx_right_band2_cut4;1");
 auto xx0c=f.Get<TH2F>("x_right_near_dx_right_band_none_cut4;1");
 ...
 xy0->Draw("colz");
 MyC.Print("r369585v7-LTRB-bands-x-vs-y.pdf");
 MyC.Print("r369585v7-LTRB-bands-x-vs-y.C");
 MyC.Print("r369585v7-LTRB-bands-x-vs-y.png");
 MyC.cd(1);
 ...
 xy0c->Draw("colz");
 MyC.Print("r369585v7-LTRB-bands-x-vs-y-cut4.pdf");
 MyC.Print("r369585v7-LTRB-bands-x-vs-y-cut4.png");
 MyC.Print("r369585v7-LTRB-bands-x-vs-y-cut4.C");

 MyC.Clear();
 MyC.Divide(2,3);
 MyC.cd(1);
 xy1cr->GetXaxis()->SetRangeUser(-7.,7.);
 xy1cr->GetYaxis()->SetRangeUser(-30.,-5.);
 xy1cr->Draw("colz");
 MyC.cd(2);
 xy2cr->GetXaxis()->SetRangeUser(-7.,7.);
 xy2cr->GetYaxis()->SetRangeUser(-30.,-5.);
 xy2cr->Draw("colz");
 MyC.cd(3);
 xy0cr->GetXaxis()->SetRangeUser(-7.,7.);
 xy0cr->GetYaxis()->SetRangeUser(-30.,-5.);
 xy0cr->Draw("colz");
 MyC.cd(4);
 xy1r->GetXaxis()->SetRangeUser(-15.,15.);
 xy1r->GetYaxis()->SetRangeUser(-30.,-5.);
 xy1r->Draw("colz");
 MyC.cd(5);
 xy2r->GetXaxis()->SetRangeUser(-15.,15.);
 xy2r->GetYaxis()->SetRangeUser(-30.,-5.);
 xy2r->Draw("colz");
 MyC.cd(6);
 xy0r->GetXaxis()->SetRangeUser(-15.,15.);
 xy0r->GetYaxis()->SetRangeUser(-30.,-5.);
 xy0r->Draw("colz");
 MyC.Print("r369585v7-LTRB-bands-x-vs-y-band_event_fraction.pdf");
 MyC.Print("r369585v7-LTRB-bands-x-vs-y-band_event_fraction.png");
 MyC.Print("r369585v7-LTRB-bands-x-vs-y-band_event_fraction.C");
 ...
 gPad->SetLogz();
 xx0->Draw("colz");
 MyC.Print("r369585v7-LTRB-bands-x-vs-dx.pdf");
 MyC.Print("r369585v7-LTRB-bands-x-vs-dx.png");
 MyC.Print("r369585v7-LTRB-bands-x-vs-dx.C");
 ...
 MyC.cd(3);
 xx0c->Draw("colz");
 MyC.Print("r369585v7-LTRB-bands-x-vs-dx-cut4.pdf");
 MyC.Print("r369585v7-LTRB-bands-x-vs-dx-cut4.png");
 MyC.Print("r369585v7-LTRB-bands-x-vs-dx-cut4.C");
}
