{
 ...
 MyC.cd(4);
 ((TH1D*) bkPk[2])->Draw();
 MyC.Print("r369585-LTRB-bkgPeak1.pdf");
 MyC.Print("r369585-LTRB-bkgPeak1.C");
 MyC.Print("r369585-LTRB-bkgPeak1.png");
 MyC.Print("r369585-LTRB-bkgPeak1.eps");
 ...
 MyC.cd(4);
 ((TH1D*) bkPk[5])->Draw();
 MyC.Print("r369585-LTRB-bkgPeak2.png");
 MyC.Print("r369585-LTRB-bkgPeak2.pdf");
 MyC.Print("r369585-LTRB-bkgPeak2.eps");
 MyC.Print("r369585-LTRB-bkgPeak2.C");
 MyC.Clear();
 ...
 gPad->SetLogy();
 ((TH1D*) bkPk[6])->Draw();
 MyC.Print("r369585-LTRB-doubleFitChi2.png");
 MyC.Print("r369585-LTRB-doubleFitChi2.pdf");
 MyC.Print("r369585-LTRB-doubleFitChi2.C");
 MyC.Print("r369585-LTRB-doubleFitChi2.eps");
}
